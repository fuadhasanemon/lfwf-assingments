...
Case Study:
	...
	My monitors have a 15.6 inch display. My monitor’s VGA cable status, yes, I will sell it for 8000 tk.
...
$numberOfDevice = 3; //ineteger/Number
$new = false; // Bollen
$deviceName = 'hp monitor'; //String
$size = 15.6; //Float
$vgaCable = true; //Bollen
$prize = 8000; //Integer/Number
